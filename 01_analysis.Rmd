...
# data.version <- "20250117_Vi_CRC_filtered_bed"
# output.version <- "20250202"
...
path.to.input <- file.path("/media/hieunguyen/GSHD_HN01/storage/PBMC", data.version)
...
for (chrom in setdiff(names(tiles), "1")){
