...
# install.packages("/media/hieunguyen/HNHD01/backup/HNSD_mini/HNSD_mini1/data/PBMC/offline_pkgs/methylKit_1.30.0.tar.gz", type = "source", repos = NULL)
# install.packages(file.path(path.to.main.src, "BSgenome.Hsapiens.UCSC.hg19_1.4.3.tar.gz"), type = "source", repos = NULL)

min.cov <- 5
analysis.version <- "0.4"
data.version <- "20240617"
output.version <- "20240715"
...
path.to.input <- file.path("/media/hieunguyen/HNHD01/backup/HNSD_mini/HNSD_mini1/data/PBMC", data.version)
path.to.main.output <- file.path(outdir, "PBMC", "output", sprintf("data_%s", data.version), output.version)
