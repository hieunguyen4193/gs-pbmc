...
data.version <- "20250117_Vi_CRC_filtered_bed_chr1"
data.group <- "20250117_Vi_CRC_filtered_bed"
...
path.to.input <- file.path("/media/hieunguyen/GSHD_HN01/storage/PBMC", data.group, data.version)
